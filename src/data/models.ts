...
export const GOLDEN_TOTO_MODELS: EVModel[] = [
  {
    ...
    colors: [
      ...
      },
      {
        ...
        hex: '#2B1B20',
        secondaryHex: '#8B263E',
        image: 'https://images.unsplash.com/photo-1558981854-3e9197fae037?auto=format&fit=crop&w=1200&q=80'
      }
    ],
    highlights: [
      {
    ...
    gallery: [
      ...
      {
        url: 'https://images.unsplash.com/photo-1558981854-3e9197fae037?auto=format&fit=crop&w=1000&q=80',
  ...
  },
  {
    ...
    badge: 'Premium',
    heroImage: 'https://images.unsplash.com/photo-1558981854-3e9197fae037?auto=format&fit=crop&w=1200&q=80',
    specs: {
      price: 134999,
      priceDisplay: '₹ 1,34,999',
      rangeIdc: '150 km',
